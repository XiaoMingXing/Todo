const Data = {
    'instructions': [
        ...
        },
        {
            ...
            'description': "In your project root create an 'app' folder. " +
            "In the app folder create an 'actions' folder , a 'reducers' folder and a 'components' folder."
        },
        {
            'title': 'Create your first action',
            'description': 'The action is a basic function called from the component whenever we want the whole state' +
            ' of the app to be changed. Our action creator is a simple function returning an object ' +
            '(the action itself)with a type attribute expressing what happened with the app.' +
            "\nIn your actions folder create a js file 'index.js'"
        },
        {
            'title': 'Create your first reducer',
            'description': 'Reducers are the ones in charge of updating the state of the app. ' +
        ...
        },
        {
            ...
            'description': 'Redux needs to inject a store holding the app state into the app. ' +
            'To do so, it requires a ‘Provider’ wrapping the whole app.In the app folder, ' +
            "create a js file 'setup.js'"
        },
        {
